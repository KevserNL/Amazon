...
//           if we do not pass the driver from terminal then use the one properties file
            ...
            switch (browser) {
                ...
                case "remote_chrome":
                    ...
                    try {
                        driverPool.set(new RemoteWebDriver(new URL("https://hawwa:8d8f179b-e1d6-4e47-99cc-30fb8ce8d3e6@ondemand.eu-central-1.saucelabs.com:443/wd/hub"), chromeOptions));
                ...
                case "mobile_chrome":
                    ...
                    desiredCapabilities.setCapability(MobileCapabilityType.PLATFORM_NAME, Platform.ANY);
                    //version of android
